var doExp1 = myLayer.extend({
    ...
    initUI:function(){
        ...
        var uiList = [
            "btn_answer", "btn_upload", "btn_tip", "btn_result","judge1", "judge2", "judge3"
        ]
        var bg = loadNode(res.fl_doExp1_json, uiList, "bg")
    ...
    getRand: function() {
        ...
        for (var i = 0; i < 8; i++) {
            cc.log(rand[i])
            list.push(sprintf("#do1_judge%d.png", rand[i]))
        }
        return list
    },
    ...
    initPeople: function() {
        ...
        this.answerImg2 = createShowImg({
            img:res.do1_tip3,
        })
        safeAdd(this, this.answerImg2)
