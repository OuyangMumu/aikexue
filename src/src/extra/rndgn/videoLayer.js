var videoLayer = myLayer.extend({
    ...
    ctor: function() {
        this._super();
        var self = this
        var playList = [17,106,287,322,347,1074,1127,1260]

        this.mv = ccs.load(res.rndgn_startMv_json).node
        this.mvac = ccs.load(res.rndgn_startMv_json).action
        this.addChild(this.mv)

        
        this.mvac.retain()
        this.mv.mvac = this.mvac
        this.mv.endFrame = 1260
