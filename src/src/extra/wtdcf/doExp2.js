...
var doExp2 = myLayer.extend({
    ...
    createTool: function() {
        ...
        var fileList = []
        for (var i = 0; i < 5; i++) {
            fileList[i] = sprintf("do2_img%d.png", i + 1)
        }
        var infoList = [{
            type: "poly",
            buf: [2, 92 - 68, 1, 92 - 27, 99, 92 - 1, 126, 92 - 23, 126, 92 - 66, 28, 92 - 91],
            offset: cc.p(-64, -46),
            mass: 0.3,
        }, {
            type: "poly",
            buf: [1, 68 - 56, 1, 68 - 14, 57, 68 - 1, 87, 68 - 12, 87, 68 - 55, 31, 68 - 68],
            offset: cc.p(-44, -34),
            mass: 0.3,
        }, {
            type: "poly",
            buf: [1, 65 - 53, 1, 65 - 14, 45, 65 - 1, 66, 65 - 11, 66, 65 - 52, 23, 65 - 64],
            offset: cc.p(-67 / 2, -65 / 2),
            mass: 0.3,
        }, {
            type: "poly",
            buf: [1, 44 - 34, 1, 44 - 7, 24, 44 - 1, 41, 44 - 10, 41, 44 - 37, 17, 44 - 43],
            offset: cc.p(-21, -22),
            mass: 0.3,
        }, {
            type: "poly",
            buf: [1, 32 - 25, 1, 32 - 5, 18, 32 - 1, 30, 32 - 7, 30, 32 - 27, 13, 32 - 31],
            offset: cc.p(-31 / 2, -16),
            mass: 0.3,
        }, ]
        ...
        var toolbtn = createTool({
            ...
            firstClick: function(data) {
                ...
                var sp = self.addItem({
                    tex: sprintf("#do2_tool%d.png", index + 1),
                    mass: info.mass,
                    disAct: true,
                    type: info.type,
                    buf: info.buf,
