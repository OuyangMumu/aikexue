var videoLayer = myLayer.extend({
    ...
    ctor: function() {
        this._super();
        var self = this
        var playList = [200,320,505,590,680]

        this.mv = ccs.load(res.wtdysyxr_startMv_json).node
        this.mvac = ccs.load(res.wtdysyxr_startMv_json).action
        this.addChild(this.mv)

        
        this.mvac.retain()
        this.mv.mvac = this.mvac
        this.mv.endFrame = 680
