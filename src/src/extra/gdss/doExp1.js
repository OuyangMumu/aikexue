...
var doExp1 = myLayer.extend({
    ...
    initFunlist:function(){
      ...
      var end5 = function(){
        ...
        if(tool_item1){
           ...
           if(result){
              this.removeListen()
              this.runAction(cc.moveTo(0.2,cc.p(307,245)))
    ...
    initUI:function(){
        ...
        this.toolbtn = createTool({
            ...
            gets:[null,res.bigitem1,res.bigitem2,res.bigitem4,res.bigitem5,res.bigitem6]
        })
    ...
    createLight:function(){
      ...
      node.light1 = createClip({
                           toShowimg:res.shu1,
                           ShowimgPos:cc.p(360,410),
                           toSencilimg:res.shu3,
                           sencilPos:cc.p(728,803),
                           father:node,
                           secil_roto:-47
                       })
      node.light2 = createClip({
                           toShowimg:res.shu2,
                           ShowimgPos:cc.p(386,227),
                           toSencilimg:res.shu3,
                           sencilPos:cc.p(-102,225),
                           father:node
                       })
      ...
      node.lightPlay = function(fun){
        ...
        var light2 = node.light2
        var mov = cc.moveTo(1.4,cc.p(360,410))
        var cal = cc.callFunc(function(){
          var mov1 = cc.moveTo(1.4,cc.p(384,227))
          var cal1 = cc.callFunc(function(){
             node.visFrom.setVisible(true)
             node.movBtn.setVisible(true)
          })
          light2.moveSecil(mov1,cal1)
        })
