...
var seeExp1 = myLayer.extend({
    ...
    initBG:function(){
        ...
        bg2.setPosition(568.59,460.77)
        this.inside_node.addChild(bg2)
        this.curBg = bg2

        var yuns = new cc.Sprite(res.yun)
        yuns.setPosition(172.17,251.63)
        bg2.addChild(yuns)

        var bg = new cc.Sprite(res.bg)
        bg.setPosition(571.86,54.85)
        bg.setScale(1.08)
        bg2.addChild(bg)
    },
    initUI:function(){
       ...
       node.sartAc = function(){
          ...
          ac.gotoFrameAndPlay(0,2680,false)
          ...
          ac.setFrameEventCallFunc(function(frame){
              ...
              if(index==1){
                self.speakeBykey("seemp1")
              }else if(index==269){
                self.speakeBykey("seemp2")
              }else if(index==415){
                self.speakeBykey("seemp3")
              }else if(index==600){
                self.speakeBykey("seemp4")
              }else if(index==900){
