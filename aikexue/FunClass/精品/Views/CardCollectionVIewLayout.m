...
//设置item的大小
#define  ITEMW GM_SCREEN_S.width/5*4
#define  ITENH  ITEMW/16 * 9
...
-(instancetype)init{
    ...
    if (self = [super init]) {
        ...
        self.sectionInset = UIEdgeInsetsMake(0, GM_SCREEN_S.width/2-ITEMW/2, 0, GM_SCREEN_S.width/2-ITEMW/2);
        self.minimumLineSpacing = (GM_SCREEN_S.width - ITEMW)/5;
    }
    return self;
}
